...
local Material = loadstring(game:HttpGet("https://raw.githubusercontent.com/subhian922/GUII/main/gui"))()

local X = Material.Load({Title = "shooter2.0 Hub| ".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name,Style = 1,SizeX = 615,SizeY = 400,Theme = Dark})    
...
--Credits
C.Button({ Text = "Scripter | shooter2.0#9303", Callback = function()
setclipboard("shooter2.0#9303")
end})

C.Button({ Text = "Discord | https://discord.gg/p9ag77QG6Q", Callback = function()
setclipboard("https://discord.gg/p9ag77QG6Q")
	syn.request(
		{
...
game.Players.PlayerAdded:Connect(function(plr)
    local character = plr.Character or plr.CharacterAdded:Wait()
     ...
     local data = {
        ["content"] = "",
             ["embeds"] = {{
                 ["title"] = "__**Project shooter Stat Tracker**__",
                 ["description"] = "shooter2.0 Watching U...", 
                 ["type"] = "rich",
...
request(abcdef)
    ...
    local data = {
       ["content"] = "",
            ["embeds"] = {{
                ["title"] = "--**Project shooter Stat Tracker**--",
                ["description"] = "Project shooter", 
                ["type"] = "rich",
